      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-muted-foreground text-sm">Avaliação Grátis</li>
              <li className="text-muted-foreground text-sm">Garantia Estendida</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-muted-foreground text-sm">
                ...
                <span>contato@autoelite.com.br</span>
              </li>
              <li className="flex items-start gap-3 text-muted-foreground text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-center text-muted-foreground text-sm">
            © {new Date().getFullYear()} AutoElite. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
