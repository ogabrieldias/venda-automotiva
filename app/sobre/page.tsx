...
export const metadata: Metadata = {
  title: "Sobre | AutoElite",
  description: "Conheça a história da AutoElite, a concessionária premium de carros e motos do Brasil.",
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6">
              Sobre a <span className="text-primary">AutoElite</span>
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Há mais de 10 anos no mercado, a AutoElite se consolidou como referência 
