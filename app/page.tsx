...
const testimonials = [
  ...
  },
  {
    ...
    role: "Médico",
    content: "Já é a terceira vez que compro na AutoElite. Confiança e qualidade que fazem a diferença.",
    rating: 5,
  },
]
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
              Por que escolher a <span className="text-primary">AutoElite</span>?
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Diferenciais que fazem da AutoElite a melhor escolha para sua próxima compra.
            </p>
          </div>
