...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    title: "E-mail",
    content: "contato@autoelite.com.br",
    subContent: "vendas@autoelite.com.br",
  },
  {
    icon: Clock,
    title: "Horário",
